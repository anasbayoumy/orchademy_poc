    ...
    return (
        <ResponsiveContainer width="100%" height={height}>
            <PieChart>
                ...
                <Tooltip contentStyle={{ background: bgColor, border: `1px solid ${gridColor}`, borderRadius: 8, fontSize: 12, color: textColor }} formatter={(value: number | undefined) => [value ?? 0, '']} />
